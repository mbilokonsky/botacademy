...
var MergeScanOperator = (function () {
    function MergeScanOperator(project, seed) {
    ...
    MergeScanOperator.prototype.call = function call(subscriber) {
...
var MergeScanSubscriber = (function (_OuterSubscriber) {
    _inherits(MergeScanSubscriber, _OuterSubscriber);

    function MergeScanSubscriber(destination, project, acc) {
    ...
    MergeScanSubscriber.prototype._next = function _next(value) {
        if (this.active < this.concurrent) {
            ...
            var ish = _utilTryCatch2['default'](this.project)(this.acc, value);
    ...
    MergeScanSubscriber.prototype.notifyNext = function notifyNext(outerValue, innerValue, outerIndex, innerIndex) {
        var destination = this.destination;
